...
public interface KelasRepo extends JpaRepository<KelasEntity, String> {
        ...
        @Query("select t from KelasEntity t where t.namaHari= :namaHari and t.ruangId= :ruangId and t.dosenId= :dosenId and (t.jamMulai>= :jamMulai or t.jamSelesai<= :jamSelesai)")
